...
(define (problem problem-pddl)
  ...
  (:init
    ...
    (IS-LECTURE-AT L1 B1) (IS-LECTURE-AT L2 B1)
    (IS-LECTURE-AT L3 B2)
    (IS-LECTURE-AT L2 B3) (IS-LECTURE-AT L4 B3)
    (IS-LECTURE-AT L1 B4) (IS-LECTURE-AT L6 B4)
    (IS-LECTURE-AT L4 B6) (IS-LECTURE-AT L5 B6)
    ...
    (teaches-lecture T1 L1) (teaches-lecture T1 L3)
    (teaches-lecture T2 L2) (teaches-lecture T2 L4)
    (teaches-lecture T3 L5) (teaches-lecture T3 L6)
  ...
  (:goal
    (and
      (attended-lecture S1 L1) (attended-lecture S1 L6)
      (attended-lecture S2 L2) (attended-lecture S2 L3)
      (attended-lecture S3 L4) (attended-lecture S3 L5)
      (attended-lecture S4 L5) (attended-lecture S4 L1)
